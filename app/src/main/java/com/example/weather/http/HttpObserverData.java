...
public abstract class HttpObserverData<T> implements Observer<HttpResultData<T>> {
    private Context mContext;
    protected abstract void onSuccess(HttpResultData<T> t);
    protected abstract void onFailure(Throwable e);
    protected abstract void onStart(Disposable d);

    protected HttpObserverData(Context context) {
    ...
    @Override
    public void onNext(@NonNull HttpResultData<T> result) {
